...
# pgtree
Unix process hierarchy tree display for specific processes (kind of mixed pgrep + pstree)  
...
## Install
FYI, the `pgt/pgtree.sh` is standalone and can be directly copied/used anywhere without any installation.

install using git:
```
# git clone https://github.com/joknarf/pgt
```
